            ...
            <div className="datatable-crud-demo">
                ...
                <div className="card">
                    ...
                    <DataTable ref={(el) => this.dt = el} value={this.state.products} selection={this.state.selectedProducts} onSelectionChange={(e) => this.setState({ selectedProducts: e.value })}
                        ...
                        <Column field="code" header="Name" sortable></Column>
                        <Column field="name" header="Email" ></Column>
                        <Column field="price" header="Phone No"  ></Column>
                        <Column field="category" header="Assigned To" ></Column>
                ...
                <Dialog visible={this.state.productDialog} style={{ width: '450px' }} header="Teacher Details" modal className="p-fluid" footer={productDialogFooter} onHide={this.hideDialog}>
                    ...
                    <div className="p-field">
                     ...
                     <div className="p-field">
                        ...
                        <InputNumber id="name" value={this.state.product.name} onChange={(e) => this.onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': this.state.submitted && !this.state.product.name })} />
                        {this.state.submitted && !this.state.product.name && <small className="p-invalid">Name is required.</small>}
                    </div>
                    ...
                    <div className="p-field">
                        ...
                        <div className="p-formgrid p-grid">
                            <div className="p-field-radiobutton p-col-6">
                                <RadioButton inputId="category1" name="category" value="074BCT" onChange={this.onCategoryChange} checked={this.state.product.category === 'Accessories'} />
                                <label htmlFor="category1">074BCT</label>
                            </div>
                             <div className="p-field-radiobutton p-col-6">
                                <RadioButton inputId="category2" name="category" value="074BCT" onChange={this.onCategoryChange} checked={this.state.product.category === 'Accessories'} />
